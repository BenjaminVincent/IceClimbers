...
if oPlayer.y < (saved_player_position - saved_screen_move_interval) and tile_collision_point_bottom_2d(collision_tile_map_id,bottom_left_point,bottom_right_point) > 0 {
